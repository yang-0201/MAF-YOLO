...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='result/model_S_ciou_reRep_SP1/weights/best_ckpt.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', type=str, default='result', help='save evaluation results to save_dir/name')
    ...
    parser.add_argument('--confile', default='./configs/exp/yolov6s_yaml.py', type=str,help='experiments description file')
...
def run(data,
    ...
    cfg = Config.fromfile(args.confile)
    model = val.init_model1(model,cfg, weights, task)
