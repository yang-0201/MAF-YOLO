...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/coco_segment.yaml', type=str, help='path of dataset')
    ...
    parser.add_argument('--output-dir', default='MAF-YOLO', type=str, help='path to save outputs')
    ...
    parser.add_argument('--save_ckpt_on_last_n_epoch', default=16, type=int, help='save last n epoch even not best or last, neg value not save')
