...
class CSPRepPANNeck(nn.Module):
    ...
    def __init__(
        ...
        # self.ffn = ConvFFN(
        #     in_channels=512, internal_channels=int(512 * 4), out_channels=512,drop_path=0
        # )
        # self.Rep_n4 = CSPNeXtLayer(
        #     in_channels=channels_list[5] + channels_list[9],
        #     out_channels=channels_list[10],
        #     num_blocks= 6,
        #     use_depthwise = True
